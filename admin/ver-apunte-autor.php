<?php ob_start(); ?>
<div id="head-apunte" class="col-9">
...
<br>
<hr class="col-9">
<div id="contenido-apunte" class="col-9">

    <h1 class="text-center">Tema 1</h1>
    <p>
...
<div class="col-3">
    <div class="fila">
        ...
        <div class="col-7">
            ...
            <p>
                ...
                <a href="mensaje-admin.php" class="boton">Enviar mensaje</a>
            </p>
        </div>
        <div class="clear"></div>
    </div>
    <div class="fila">
        ...
        <span class="col-3"><span class="fa fa-eye"></span> 999</span>
        <span class="col-3"><span class="fa fa-trash-o"></span></span>
        <br>
    </div>
</div>
