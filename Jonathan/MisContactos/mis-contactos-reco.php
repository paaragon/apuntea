...
<body>
    ...
    <div class="col-9" id="principal">
        <h2>
            <i class="fa fa-users"></i> Contactos Recomendados
        </h2>
        <hr>
        <div>
            <!-- Linea de botones-->
            <p>
                ...
                <a href="#" class="boton"><span class="fa fa-star"></span> Recomendados</a>
            ...
            <div class="fila">
                ...
                <div class="profile fila">
                    ...
                    <div class="description">
                        ...
                        <p class="pretext">Vamos a ganar la Champions</p>
            ...
            <div class="fila">
                <div class="profile fila">
                    ...
                    <div class="description">
                        ...
                        <a href="perfil-usuario.php" class="color-green">@cho1_</a>
                        <button class="green border-green">Mensaje</button>
                        <p class="pretext">Vamos a ganar la Liga</p>
