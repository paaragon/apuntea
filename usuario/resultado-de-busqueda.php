        ...
        <?php foreach ($variables["usuarios"] as $usuario) { ?>
            <div class="fila">
                <p>
                    ...
                    <span class="col-3"><a href="universidad.php?id=<?php echo ($usuario->carrera != null) ? $usuario->carrera->universidad->universidad_id : "" ?>"><span class="fa fa-university"></span><?php echo ($usuario->carrera != null) ? $usuario->carrera->universidad->siglas : "Sin universidad" ?></a></span>
                    <span class="col-3"><a href="carrera.php?id=<?php echo ($usuario->carrera != null) ? $usuario->carrera->id : "" ?>"><span class="fa fa-graduation-cap"></span><?php echo ($usuario->carrera != null) ? $usuario->carrera->nombre : "Sin carrera" ?></a></span>
                </p>
                <div class="clear"></div>
            </div>
        <?php } ?>
