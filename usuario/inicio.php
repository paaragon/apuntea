...
<div class="col-9" id="principal">
    <div>
        <p>
            <a href="#" class="boton boton-activo"><span class="fa fa-file-o"></span> Mis aportaciones </a>
            <a href="mis-novedades.php" class="boton"><span class="fa fa-star"></span> Novedades </a>
        </p>
    </div>
    <div>
        <div class="fila">
