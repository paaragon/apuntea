...
<div id="principal">
    ...
    <hr>
    <div>
        <?php if (count($variables["nuevosAmigos"]) > 0 || count($variables["nuevosContactosGrupo"]) > 0 || count($variables["nuevosApuntes"]) > 0): ?>
            <!-- NUEVOS AMIGOS -->
        ...
        <?php else: ?> 
            <blockquote><h3>No tienes actividad reciente</h3></blockquote>
        <?php endif; ?>
